...
public class RegistrationServiceImpl implements RegistrationService {
    ...
    public RegistrationServiceImpl(UserServiceImpl userserviceimpl, EmailValidatorServiceImpl emailValidatorServiceImpl, ConfirmationTokenServiceImpl confirmationTokenServiceImpl, EmailSender emailSender) {
        this.userserviceimpl = userserviceimpl;
        this.emailValidatorServiceImpl = emailValidatorServiceImpl;
    ...
    public String register(RegistrationRequest request) {
        boolean isValidEmail = emailValidatorServiceImpl.test(request.getEmail());
